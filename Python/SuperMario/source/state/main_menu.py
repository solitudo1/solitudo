...
class MainMenu:
    ...
    def draw(self, surface):
        ...
        hint = hint_font.render(
            "Use UP/DOWN to select, ENTER to confirm", True, C.WHITE
        )
